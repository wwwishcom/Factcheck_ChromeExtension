...
RSS_FEEDS = [
    ...
    {"source": "네이버-세계", "url": "https://news.naver.com/rss/world.xml"},
    {"source": "네이버-스포츠","url": "https://news.naver.com/rss/sports.xml"},
    ...
    {"source": "SBS",        "url": "https://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=01&plink=RSSREADER"},
    {"source": "중앙일보",   "url": "https://rss.joins.com/joins_news_list.xml"},
    {"source": "경향신문",   "url": "https://www.khan.co.kr/rss/rssdata/total_news.xml"},
    {"source": "YTN",        "url": "https://www.ytn.co.kr/rss/"},
]

RSS_CRAWL_COUNT = 50  # 언론사당 최대 수집 건수
...
async def crawl_rss():
    ...
    for feed_info in RSS_FEEDS:
        try:
            ...
            for entry in feed.entries[:RSS_CRAWL_COUNT]:
